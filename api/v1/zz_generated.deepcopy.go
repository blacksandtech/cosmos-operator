...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SyncInfoStatus) DeepCopyInto(out *SyncInfoStatus) {
	*out = *in
	if in.Pods != nil {
		in, out := &in.Pods, &out.Pods
		*out = make([]SyncInfoPodStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SyncInfoStatus.
func (in *SyncInfoStatus) DeepCopy() *SyncInfoStatus {
	if in == nil {
		return nil
	}
	out := new(SyncInfoStatus)
